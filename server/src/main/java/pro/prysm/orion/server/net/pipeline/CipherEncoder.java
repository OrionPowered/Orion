...
// https://github.com/PaperMC/Velocity/blob/dev/3.0.0/proxy/src/main/java/com/velocitypowered/proxy/protocol/netty/MinecraftCipherEncoder.java
/*
...
public class CipherEncoder extends MessageToMessageEncoder<ByteBuf> {
    ...
    protected void encode(ChannelHandlerContext ctx, ByteBuf buf, List<Object> list) {
        ByteBuf compatible = MoreByteBufUtils.ensureCompatible(ctx.alloc(), cipher, buf);
        try {
